    ...
    return (
        <div className="text-neutral-600 lg:hidden flex flex-col items-center pt-8 gap-2 justify-center">
            <div className="flex flex-col justify-center items-center h-full">
                <Image src={"/img/avatar.jpg"} width={200} height={200} alt="Imagem de perfil" className="rounded-full p-3 mt-2 shadow-lg shadow-slate-800" />
                <div className="w-30 mt-8 py-2 flex flex-col items-center justify-center gap-4">
                    <div className="w-6 h-6 rounded-full shadow-lg shadow-black" ></div>
                    <div className="w-5 h-5 rounded-full shadow-lg shadow-black"></div>
                    <div className="w-4 h-4 rounded-full shadow-lg shadow-black"></div>
            ...
            <div className="flex flex-col items-center justify-center gap-6 py-10 px-1 w-4/5 mb-2 bg-orange-100 rounded-xl border-4 border-slate-800 shadow-lg shadow-black">
                ...
                <div className="flex gap-5 mb-4">
                    <a href="https://www.linkedin.com/in/hudsonsanto/" target="_blank" className="flex items-center gap-1 text-xl p-1 px-2.5 bg-blue-400 rounded-3xl shadow-md shadow-black">Linkedin<BiLogoLinkedinSquare /></a>
                    <a href="https://github.com/HudsnF" target="_blank" className="flex items-center gap-1 text-xl p-1 px-2 bg-neutral-400 rounded-3xl shadow-md shadow-black">Github<BiLogoGithub /></a>
                </div>
