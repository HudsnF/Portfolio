    ...
    return (
        <div className="h-[calc(100vh-80px)] hidden lg:flex flex-col items-center justify-center">
            ...
            <div className="py-5 flex flex-row-reverse items-center justify-center">
                ...
                <div className="w-3/6 mr-4 text-xl flex flex-col items-center py-8 text-center gap-4 px-10 border-t-4 border-b-2 border-black rounded-full rounded-tl-xl shadow-lg shadow-black bg-orange-300">
