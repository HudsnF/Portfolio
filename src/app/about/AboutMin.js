export default function AboutMin() {
    return (
        <div className="lg:hidden flex flex-col gap-10 items-center justify-start py-10">
            ...
            <div className="w-3/4 flex flex-col items-center text-center border-2 border-orange-950 rounded-xl shadow-lg shadow-slate-800 overflow-y-scroll scrollbar-none text-slate-800">
